...
const subjects = [
  {
    name: '과목1',
    examFile: path.join(baseDir, '문제은행', '과목1_단일정답형.md'),
  ...
  {
    name: '과목2',
    examFile: path.join(baseDir, '문제은행', '과목2_단일정답형.md'),
  ...
  {
    name: '과목3',
    examFile: path.join(baseDir, '문제은행', '과목3_단일정답형.md'),
  ...
  {
    name: '과목4',
    examFile: path.join(baseDir, '문제은행', '과목4_단일정답형.md'),
