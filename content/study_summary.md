...
> 📚 **교재 콘텐츠 5대 학습 보조 적용 완료** (2026-08-27)
> 전 교재(4과목 19단원) Markdown 원본에 다음 5가지 학습 보조 요소가 추가되었습니다:
> - **학습 가이드**: 단원별 출제 빈도(★), 예상 소요 시간, 핵심 키워드
> - **한 줄 요약**: 각 섹션 핵심 내용 blockquote 요약
> - **비교표**: 주요 개념·수치·기준 비교 표
> - **확인문제**: 객관식 4지선다 + 상세 해설
> - **용어 사전**: 단원별 핵심 용어 정리 표
