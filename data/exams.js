...
var EXAMS_LIST = {
  "schemaVersion": 1,
  "note": "시험 레지스트리 — 새 시험은 이 파일에 엔트리를 추가하고 content/exams/<id>/ + data/exams/<id>/ 구조로 콘텐츠를 배치한다. data/exams.js 는 tools/build_exams_list.js가 이 파일에서 생성한다.",
  "exams": [
    {
      "id": "cosmetic",
      "name": "맞춤형화장품 조제관리사",
      ...
      "registryBundle": "data/registry.js",
