...
*   **종합 성적 및 과목별 과락 진단 보고서**: 답안 제출 즉시 총점 외에도 **1~4과목별 상세 문항 수 및 득점률 프로그레스 바**가 제공됩니다. 이 중 40% 미만 점수를 취득한 과목이 있는 경우 `[과락]` 딱지와 경고문이 출력되며, 해당 과목 기출 퀴즈로 바로 이동해 연습할 수 있는 **맞춤 보완 학습 버튼**이 동적으로 자동 생성됩니다.
