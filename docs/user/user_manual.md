...
*   📚 과목별 학습 우선순위와 시간 배분 추천은 **[학습 안내서](/content/학습안내서.md)**의 "5. 추천 학습 방법" 섹션을 참조하세요.
...
*   **원료 데이터베이스 연동**: 워크스페이스 내의 원료 정보(`content/참조자료/원료/` 폴더의 `approved_ingredients.md`, `restricted_ingredients.md`, `banned_ingredients.md`)를 자동으로 파싱하여 동적으로 문제를 생성합니다.
*   **4가지 핵심 학습 유형**:
...
> 📚 **학습 전략 상세 안내**: 출제비중 기반 우선순위 등급(S/A/B/C), 과목별 학습 순서, 시간 배분 추천 등은 **[학습 안내서](/content/학습안내서.md)**의 "5. 추천 학습 방법" 섹션을 참조하세요.
