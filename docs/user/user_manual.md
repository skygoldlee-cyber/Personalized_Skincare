...
*   **사이드바 3그룹**: 데스크톱 좌측 메뉴는 용도별로 세 그룹에 정리되어 있습니다.
    ...
    *   **실무** — Formula OS (실전 배합 작업실) — 사용법은 [실무 매뉴얼](doc:formula_manual) 참조
    *   **자료 · 도구** — 교재 본문 읽기 · 교재 본문 검색 · 성분 검색 사전 · 학습 캘린더
*   **⚙️ 설정 메뉴**: 화면 우측 상단의 톱니바퀴 버튼을 누르면 관리 기능이 한곳에 모여 있습니다 — 데이터 백업, 백업 가져오기, 학습 매뉴얼·실무 매뉴얼, 진도 초기화. 메뉴는 항목을 선택하거나 바깥을 누르면 자동으로 닫힙니다.
