...
*   **ㄱㄴㄷㄹ 합답형 모의고사**: 각 과목 카드의 `합답형 모의고사` 버튼을 누르면 문항 수 선택 행(20/40/60/전체 N문)이 펼쳐집니다. 합답형 문항(과목별 102/250/250/408제)은 원본 문제은행 문항의 교재 근거를 ㄱ~ㅁ 진술 조합으로 자동 변환한 것으로, 실전 시험의 "옳은 것을 모두 고르시오" 패턴을 훈련합니다.
