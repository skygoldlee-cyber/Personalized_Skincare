...
*   **학습 도구 펼침**: 사이드바의 **[학습 도구 ▾]** 라벨을 누르면 숨겨진 학습 메뉴를 일시적으로 펼쳐 사용할 수 있습니다 (펼침 상태 기억).
*   **실무 중심 구성**: 실무 매뉴얼이 최상단으로 이동하고, 남는 메뉴는 실무 작업실·성분 검색 사전·테마·시험 전환뿐입니다. 모바일 탭 바는 14개 → **5개**(테마/실무/성분검색/실무매뉴얼/시험전환)로 축소됩니다.
...
*   **14개 탭**: 테마 / 대시보드 / 카드 / 퀴즈 / 모의고사 / 훈련소 / 복습 / 교재읽기 / 교재검색 / 실무 / 성분검색 / 캘린더 / 매뉴얼 / 시험전환으로 구성되어 있으며, 자주 사용하는 학습 메뉴가 앞쪽에 배치되어 있습니다. 가로 스크롤로 전체 메뉴에 접근할 수 있고, 스크롤 가능한 방향 끝에는 그림자 힌트가 표시됩니다. 실무 모드에서는 학습 탭이 빠져 5개(테마/실무/성분검색/실무매뉴얼/시험전환)로 축소됩니다.
