...
| [CHANGES.md](dev/CHANGES.md) | 코드 변경 이력 (Changelog) | #27 매뉴얼 재정리, #26 교재 5대 학습 보조 개선, #25 학습 보조 도구, #24 Mermaid 다이어그램, #23 CSP 이벤트 위임, #41 이야기형 교재 5가지 서사 개선 |
| [IMPROVEMENTS_REPORT.md](dev/IMPROVEMENTS_REPORT.md) | 보완 및 개선점 보고서 | 11개 섹션 개선 완료 (모듈 분할, ESM, 테스트, CI/CD, UI/UX, 콘텐츠 학습 보조, 매뉴얼 재정리, 이야기형 교재 서사 개선 등) |
