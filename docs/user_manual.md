...
```
┌─────────────────────┐     ┌──────────────────────┐     ┌──────────────────────┐
│  대시보드 진도 체크  │ ──▶ │  개념 플래시카드 암기  │ ──▶ │  빈칸 채우기 기출 퀴즈 │
└─────────────────────┘     └──────────────────────┘     └──────────┬───────────┘
                                                                    │
                                                                    ▼
┌─────────────────────┐     ┌──────────────────────┐     ┌──────────────────────┐
│  스마트 훈련소       │     │  오답/중요 복습 수집   │ ◀── │  실전 예상문제집 & OMR │
│  (수치 암기 & 계산)  │ ──▶ │  (약점 카드 집중 퀴즈) │     └──────────────────────┘
└─────────┬───────────┘     └──────────┬───────────┘
          │                            │
          └───────────┬────────────────┘
                      ▼
...
*   **📖 실전 예상문제집 뷰어** `신규!`: 각 과목 카드의 `문제집` 버튼을 누르면 앱 안에서 바로 전체화면 뷰어가 열립니다(별도 창/팝업 아님).
