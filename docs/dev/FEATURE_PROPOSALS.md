...
> **작성일**: 2026-09-11
> **개정일**: 2026-09-11 — 합격 핵심 루프 중심 재구성, Free/Pro 균형 조정, PASS MASTER 브랜드 전략 반영
> **목적**: 단순 기능 목록이 아닌, **"사용자를 합격 상태까지 자동으로 끌어가는 플랫폼"** 의 핵심 제품 전략 문서
...
8. [전체 기능 카탈로그](#8-전체-기능-카탈로그)
9. [구현 순서 요약](#9-구현-순서-요약)
...
> 기존 30개에서 24개로 축소. Phase 1에 6개 핵심 기능을 집중.
