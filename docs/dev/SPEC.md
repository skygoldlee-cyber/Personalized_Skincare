...
| ROAD-L4 | **Phase 2 차별화**: 출제 패턴 분석·코칭 리포트·지식 맵·요약 노트 | FEATURE_PROPOSALS Phase 2 | 미구현 |
...
| ID | 요구사항 | 비고 | 상태 |
|----|---------|------|------|
| ROAD-M1 | **타 시험 등록**: 멀티시험 구조(DA-06)는 완비 — 신규 시험은 콘텐츠 배치+레지스트리 엔트리만으로 추가 가능. 후보 시험 평가는 `PRO_MULTI_EXAM_EVALUATION.md` | 시험 선정·콘텐츠 제작이 실제 병목 | 구조 완비, 시험 미선정 |
